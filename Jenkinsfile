...
pipeline {
    ...
    environment {
        ...
        EMAIL_RECIPIENTS = 'saikrishnamiryalkar06@gmail.com, sk.miryalkar@texasai.ai'
    }
            ...
            <table class="status-table">
                ...
                <tr>
                    ...
                    <td><a href="${env.BUILD_URL}PROD_20HTML_20Report">View</a></td>
                        ...
                        from: 'CI Notifications <miryalkarkrishna09@gmail.com>',
                        replyTo: 'miryalkarkrishna09@gmail.com'
                    )
                } catch (Exception e) {
