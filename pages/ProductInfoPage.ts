...
export class ProductInfoPage {
    ...
    constructor(page: Page) {
        ...
        this.imageCount = page.locator(`//ul[@class='thumbnails']/li/a`);
        this.productMetaData = page.locator(`(//div[@class='btn-group']/following-sibling::ul[@class='list-unstyled'])[1]/li`);
        this.productPriceData = page.locator(`(//div[@class='btn-group']/following-sibling::ul[@class='list-unstyled'])[2]/li`);
    }
